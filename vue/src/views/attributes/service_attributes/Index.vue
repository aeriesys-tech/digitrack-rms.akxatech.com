                    ...
                    <ol class="breadcrumb fs-sm mb-1">
                        <li class="breadcrumb-item" aria-current="page">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">
                                <a href="javascript:void(0)">Service Attributes</a></li>
                    </ol>
                ...
                <div class="col-12">
                    <div class="card card-one">
                        <div class="card-header d-flex justify-content-between">
                            <h6 class="card-title">Service Attributes</h6>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="table-responsive table-responsive-sm">
                                <table class="table table-sm text-nowrap table-striped table-bordered mb-0">
                                    ...
                                    <tbody>
                                        <tr v-if="serviceattributes.length==0">
                                            <td colspan="10" class="text-center">No records found</td>
                                        </tr>
                                        <tr v-for="serviceattribute, key in serviceattributes" :key="key">
                                            <td class="text-center">{{ meta.from + key }}</td>
                                            <td>{{serviceattribute.field_name}}</td>
                                            <td>{{serviceattribute.display_name}}</td>
                                            <td>{{serviceattribute.field_type}}</td>
                                            <td>{{serviceattribute.field_values}}</td>
                                            <!-- <td>{{serviceattribute?.list_parameter?.list_parameter_name }}</td> -->
                                            <td>{{serviceattribute.field_length}}</td>
                                            <!-- <td v-if="serviceparameter.is_required">Yes</td> -->
                                            <td>{{serviceattribute?.is_required==1 ?'Yes' : 'No'  }}</td>
                                            <td>
    ...
    export default {
        ...
        methods: {
            index() {
                ...
                this.$store.dispatch('post', { uri: 'paginateServiceAttributes', data: vm.meta })
                    .then(response => {
                        loader.hide();
                        this.serviceattributes = response.data.data;
            ...
            deleteServiceAttribute(serviceattribute) {
                let vm = this;
                let loader = vm.$loading.show();
                vm.$store
                    .dispatch("post", {
                        uri: "deleteServiceAttribute",
