                        ...
                        <div class="card-body ">
                            <div class="row g-2">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" placeholder="Field Name " class="form-control" :class="{'is-invalid':errors.field_name}" v-model="asset_attribute.field_name" ref="field_name"/>
                                ...
                                <div class="col-md-6">
                                    <div class="form-label">
                                        ...
                                        <!-- <Multiselect v-model="selected_asset_types" :options="options"></Multiselect> -->

                                        <MultiSelect
                                            v-model="selected_asset_types"
                                            filter
                                            ...
                                            @change="AssetTypeFilter(selected_asset_types)"
                                        />
    ...
    export default {
        ...
        methods: {
            ...
            discard() {
                ...
                AssetTypeFilter(selected_asset_types) {
                let vm = this;
                let name = "";
                vm.asset_type_ids = [];
                selected_asset_types.map(function (ele) {
                    vm.asset_type_ids.push(ele.asset_type_id);
                    if (name == "") {
                        name = ele.asset_type;
                    } else {
                        name = name + ", " + ele.asset_type;
                    }
                });
