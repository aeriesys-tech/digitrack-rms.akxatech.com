            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-2">
                <div>
                    <ol class="breadcrumb fs-sm mb-1">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">User Variables</li>
                    </ol>
                    <h4 class="main-title mb-0">User Variables</h4>
                </div>
                <router-link to="/process_registers/create" class="btn btn-primary" style="float: right;"><i class="ri-list-check"></i> Add User Variable</router-link>
            </div>
            <div class="row">
                <div class="col-12">
                    <div class="card card-one">
                        <div class="card-header d-flex justify-content-between">
                            <h6 class="card-title">User Variables</h6>
                        </div>
                        <div class="card-body">
                                ...
                                <table class="table table-sm text-nowrap table-striped table-bordered mb-0">
                                    ...
                                    <tbody>
                                        <tr v-for="user_variable, key in user_variables" :key="key">
                                            ...
                                            <td>{{user_variable.reference_no}}</td>
                                            <td>{{user_variable.reference_date}}</td>
