                ...
                <div>
                    <ol class="breadcrumb fs-sm mb-1">
                        <li class="breadcrumb-item" aria-current="page">
                            ...
                            <li class="breadcrumb-item" aria-current="page">
                                <a href="javascript:void(0)">Pendings/Overdues</a></li>
                        <!-- <li class="breadcrumb-item active" aria-current="page">Pendings/Overdues</li> -->
                    </ol>
                    <h4 class="main-title mb-0">Pendings/Overdues</h4>
                </div>
                ...
                <div class="col-12">
                    <div class="card card-one">
                        <div class="card-header d-flex justify-content-between">
                            <h6 class="card-title">Pendings/Overdues</h6>
                        </div>
                        <div class="card-body">
                            <div class="row">
                                <div class="col-3">
                                    <select class="form-control form-control-sm mb-2" v-model="meta.asset_id" @change="search()">
                                        ...
                                        <option v-for="asset, key in assets" :key="key" :value="asset.asset_id">{{ asset.asset_code }}</option>
                                    </select>
                                </div>
                                <div class="col-3">
    ...
    export default {
        ...
        methods: {
            index() {
                ...
                this.$store.dispatch('post', { uri: 'getPendingServices', data: vm.meta })
                    .then(response => {
                        loader.hide();
                        this.user_services = response.data.data;
