        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-2">
            <div>
                <ol class="breadcrumb fs-sm mb-1">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Asset Templates</li>
                </ol>
            ...
            <div class="col-12">
                <div class="card card-one">
                    <div class="card-header d-flex justify-content-between">
                        <h6 class="card-title">Asset Templates</h6>
                    </div>
                    <div class="card-body">
...
<script>
    ...
    // },
         beforeRouteEnter(to, from, next) {
        next((vm) => {
            if(from.name == 'AssetTemplates.Edit' && from.name == 'AssetTemplates.View'){
                vm.meta.page = vm.$store.getters.current_page
            }else{
                vm.meta.page = 1
            }
        ...
        methods: {
            index() {
                ...
                vm.$store
                    .dispatch("post", { uri: "paginateAssetTemplates", data: vm.meta })
                    .then((response) => {
                        loader.hide();
            ...
            editAsset(asset) {
                ...
                this.$router.push("/asset_template/" + asset.asset_template_id + "/edit");
            },
            viewAsset(asset) {
                ...
                this.$router.push("/asset_template/" + asset.asset_template_id + "/view");
            },
