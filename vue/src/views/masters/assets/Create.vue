                                ...
                                <div class="col-md-4" v-for="field, key in asset.asset_attributes" :key="key">
                                    ...
                                    <div v-if="field.field_type === 'Date&Time'">
                                        ...
                                        <input type="datetime-local" class="form-control"
                                            :placeholder="'Enter ' + field.field_name"
                                            :class="{ 'is-invalid': errors[field.field_name] }"
                                            v-model="field.asset_attribute_value.field_value" step="1" />
                                    ...
                                    <div v-if="field.field_type == 'Dropdown'">
                                        ...
                                        <select class="form-control"
                                            ...
                                            v-model="field.asset_attribute_value.field_value">
                                            <option :value="field.asset_attribute_value.field_value"
                                                v-if="field.asset_attribute_value.field_value">
                                                {{ field.asset_attribute_value.field_value }}</option>
                                            <option :value="field.asset_attribute_value.field_value" v-else>Select
                                    ...
                                    <div v-if="field.field_type == 'Color'">
                                        ...
                                        <input type="color" class="form-control"
                                            v-model="field.asset_attribute_value.field_value" style="height: 2.2rem;" />
