                            ...
                            <div class="row g-2">
                                ...
                                <div class="col-md-4" v-for="field, key in show_break_downs" :key="key">
                                    <div v-if="field.field_type=='Text'">
                                        ...
                                        <input v-if="field.break_down_attribute_value" type="text" class="form-control" :placeholder="'Enter '+ field.field_name" :class="{'is-invalid': errors[field.field_name]}" v-model="field.break_down_attribute_value.field_value" @blur="updateBreakDownParameters(field)" />
                                        <input v-else type="text" class="form-control" :placeholder="'Enter '+ field.field_name" :class="{'is-invalid': errors[field.field_name]}" v-model="field.field_value" @blur="updateBreakDownParameters(field)" />
                                        <span v-if="errors[field.field_name]" class="invalid-feedback">{{ errors[field.field_name][0] }}</span>
                                    </div>
                                    
                                    <div v-if="field.field_type=='Number'">
                                        <label  class="form-label">{{field.field_name}}</label><span v-if="field.is_required" class="text-danger">*</span>
                                        <input v-if="field.break_down_attribute_value" type="text" class="form-control" min="0" oninput="validity.valid||(value='');" :placeholder="'Enter '+ field.field_name" :class="{'is-invalid': errors[field.field_name]}" v-model="field.break_down_attribute_value.field_value" @blur="updateBreakDownParameters(field)" />
                                        <input v-else type="text" class="form-control" min="0" oninput="validity.valid||(value='');" :placeholder="'Enter '+ field.field_name" :class="{'is-invalid': errors[field.field_name]}" v-model="field.field_value" @blur="updateBreakDownParameters(field)" />
                                        <span v-if="errors[field.field_name]" class="invalid-feedback">{{ errors[field.field_name][0] }}</span>
                                    </div>
                                    ...
                                    <div v-if="field.field_type === 'Date'">
                                        ...
                                        <input v-if="field.break_down_attribute_value"  type="date" class="form-control" :placeholder="'Enter ' + field.field_name" :class="{'is-invalid': errors[field.field_name]}" v-model="field.break_down_attribute_value.field_value" @blur="updateBreakDownParameters(field)" />
                                        <input v-else type="date" class="form-control" :placeholder="'Enter ' + field.field_name" :class="{'is-invalid': errors[field.field_name]}" v-model="field.field_value" @blur="updateBreakDownParameters(field)" />
                                    ...
                                    <div v-if="field.field_type=='Dropdown'">
                                        <label  class="form-label">{{field.field_name}}</label><span v-if="field.is_required" class="text-danger">*</span>
                                        <select v-if="field.break_down_attribute_value" class="form-control" :class="{'is-invalid': errors[field.field_name]}" v-model="field.break_down_attribute_value.field_value" @change="updateBreakDownParameters(field)">
                                            <option value="">Select {{field.field_name}}</option>
                                            <option v-for="value, key in field.field_values.split(',')" :key="key" :value="value">{{value}}</option>
                                        </select>
                                        <select v-else class="form-control" :class="{'is-invalid': errors[field.field_name]}" v-model="field.field_value" @change="updateBreakDownParameters(field)">
                                            <option value="">Select {{field.field_name}}</option>
                                            <option v-for="value, key in field.field_values.split(',')" :key="key" :value="value">{{value}}</option>
                                        </select>
                                        <span v-if="errors[field.field_name]" class="invalid-feedback">{{ errors[field.field_name][0] }}</span>
    ...
    beforeRouteEnter(to, from, next) {
            next((vm) => {
                ...
                if (to.name == "BreakDownLists.Create") {
                    ...
                    vm.status = false;
                    let uri = { uri: "getBreakDownData", data: { break_down_id: to.params.break_down_id } };
                    vm.$store
                        .dispatch("post", uri)
