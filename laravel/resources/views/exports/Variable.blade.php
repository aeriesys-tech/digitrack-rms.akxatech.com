    ...
    <table border="1" width="100%" class="table" style="border-collapse: collapse;">
        ...
        <tbody>
            @foreach($variables as $variable)
                <tr>
                    <td style="text-align: center;">{{ $variable->variable_type_id }}</td>
                    <td style="text-align: center;">{{ $variable->variable_code }}</td>
                    <td style="text-align: center;">{{ $variable->variable_name }}</td>
                    <td style="text-align: center;">{{ $variable->list_parameter_id }}</td>
                </tr>
            @endforeach
        </tbody>
    </table>
