...
use App\Exports\ActivityRegistersExport;
...
class ExportActivityRegistersJob implements ShouldQueue
{
    ...
    public function handle()
    {
        ...
        $filename = 'activity_register_' . now()->format('Ymd_His') . '.xlsx';
        ...
        $excel = Excel::raw(new ActivityRegistersExport($activities), \Maatwebsite\Excel\Excel::XLSX);
